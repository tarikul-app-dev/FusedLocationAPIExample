...
import static limited.it.tarikul.locationtrack.util.SaveAndGetData.saveToSharedPreferences;
    ...
    public void onLocationChanged(Location location) {
      //  Toast.makeText(MainActivity.this,"Location Changed",Toast.LENGTH_SHORT).show();
        if(location!=null){
            ...
            saveToSharedPreferences("latitude", String.valueOf(location.getLatitude()),MainActivity.this);
            saveToSharedPreferences("longitude", String.valueOf(location.getLongitude()),MainActivity.this);
